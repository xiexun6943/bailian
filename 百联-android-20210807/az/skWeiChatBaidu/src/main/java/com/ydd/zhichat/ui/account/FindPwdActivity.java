...
public class FindPwdActivity extends BaseActivity implements View.OnClickListener {
    ...
    private void initView() {
        mobileCountry = getIntent().getStringExtra("country");
                ...
                .execute(new BaseCallback<Void>(Void.class) {
                    ...
                    public void onResponse(ObjectResult<Void> result) {
                        ...
                        if (Result.checkSuccess(FindPwdActivity.this, result)) {
                            Toast.makeText(FindPwdActivity.this, InternationalizationHelper.getString("JXAlert_UpdateOK"), Toast.LENGTH_SHORT).show();
                            if (coreManager.getSelf() != null
                    ...
                    public void onError(Call call, Exception e) {
                        DialogHelper.dismissProgressDialog();
                        Toast.makeText(FindPwdActivity.this, InternationalizationHelper.getString("JXServer_ErrorNetwork"), Toast.LENGTH_SHORT).show();
                    }
                });
    }
                ...
                .execute(new BaseCallback<Code>(Code.class) {
                    ...
                    public void onResponse(ObjectResult<Code> result) {
                        ...
                        if (result.getResultCode() == 1) {
                            ...
                            Toast.makeText(FindPwdActivity.this, R.string.verification_code_send_failed, Toast.LENGTH_SHORT).show();
                        }
                    }
