...
-keep class com.ydd.zhichat.activity.** {*;}
...
-keep class com.ydd.zhichat.util.SkinUtils.Skin { *; }
-keep class com.ydd.zhichat.bean.** { *; }
-keep class com.ydd.zhichat.ui.live.bean.** { *; }
-keep class com.ydd.zhichat.ui.mucfile.bean.** { *; }
...
-keep class com.ydd.zhichat.ui.me.redpacket.alipay.** { *; }
-keep class com.alipay.android.app.IAlixPay{*;}
-keep class com.alipay.android.app.IAlixPay$Stub{*;}
-keep class com.alipay.android.app.IRemoteServiceCallback{*;}
-keep class com.alipay.android.app.IRemoteServiceCallback$Stub{*;}
