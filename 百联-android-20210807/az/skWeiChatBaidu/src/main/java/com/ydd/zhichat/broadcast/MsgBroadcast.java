...
public class MsgBroadcast {
    ...
    public static final String ACTION_MSG_UPDATE_CHAT = AppConfig.sPackageName + ".action.msg_chat_update";       // 聊天单聊界面的更新
    ...
    public static void broadcastMsgChatUpdate(Context context, String packetId) {
        Intent intent = new Intent(ACTION_MSG_UPDATE_CHAT);
        intent.putExtra("packetId", packetId);
        context.sendBroadcast(intent);
    }
}
