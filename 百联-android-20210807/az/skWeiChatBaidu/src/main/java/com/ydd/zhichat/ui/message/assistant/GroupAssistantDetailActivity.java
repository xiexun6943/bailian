package com.ydd.zhichat.ui.message.assistant;
...
import com.ydd.zhichat.bean.assistant.GroupAssistant;
import com.ydd.zhichat.bean.assistant.GroupAssistantDetail;
import com.ydd.zhichat.bean.assistant.KeyWord;
...
public class GroupAssistantDetailActivity extends BaseActivity implements View.OnClickListener {
    ...
    public void helloEventBus(final EventNotifyByTag message) {
        if (TextUtils.equals(message.tag, "GroupAssistantKeyword")) {
            initData();
        }
    }
