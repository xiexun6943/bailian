...
import com.ydd.zhichat.adapter.SelectBankAdapter;
...
public class SelectBankPop extends PopupWindow {
    ...
    public SelectBankPop(final Activity activity, ArrayList<SelectWindowModel> list) {
        super(activity);
        ...
        adapter = new SelectBankAdapter(list);
    ...
    public void initListener() {
        adapter.setOnItemClickListener(new SelectBankAdapter.OnItemClickListener() {
            @Override
