...
import com.ydd.zhichat.ui.message.HandleActivityDestroyedDoSomeThing;
            ...
            if (action.equals(MsgBroadcast.ACTION_FACE_GROUP_NOTIFY) && isQuery) {
                ...
                if (TextUtils.equals(operating, "notify_list")) {
                    ...
                    if (friend != null) {
                        ...
                        Toast.makeText(context, "进入群组失败", Toast.LENGTH_SHORT).show();
                    }
                    finish();
                }
            }
...
//        a_sure_btn.setBackgroundColor(SkinUtils.getSkin(this).getAccentColor());
