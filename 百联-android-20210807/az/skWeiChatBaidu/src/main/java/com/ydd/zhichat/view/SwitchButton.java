...
public class SwitchButton extends CompoundButton {
    ...
    private void init(AttributeSet attrs) {
        ...
        mProcessAnimator =
                ObjectAnimator.ofFloat(this, "process", 0, 0).setDuration(DEFAULT_ANIMATION_DURATION);
        ...
        if (ta != null) {
            ...
            thumbRadius = ta.getDimension(R.styleable.SwitchButton_kswThumbRadius,
        ...
        if (!mIsThumbUseDrawable && mThumbColor == null) {
            mThumbColor = DisplayUtil.generateThumbColorWithTintColor(mTintColor);
        ...
        backDrawable = getResources().getDrawable(R.drawable.ios_back_drawable_green);

        mBackDrawable = backDrawable;
        mBackColor = backColor;
        mIsBackUseDrawable = mBackDrawable != null;
        if (!mIsBackUseDrawable && mBackColor == null) {
            mBackColor = DisplayUtil.generateBackColorWithTintColor(mTintColor);
    ...
    private int measureHeight(int heightMeasureSpec) {
        ...
        int minHeight =
                (int) Math.max(mThumbSizeF.y, mThumbSizeF.y + mThumbMargin.top + mThumbMargin.right);
    ...
    private void setup() {
        ...
        mBackRectF.set(backLeft, mThumbRectF.top - mThumbMargin.top,
                backLeft + mThumbMargin.left + mThumbSizeF.x * mBackMeasureRatio + mThumbMargin.right,
                mThumbRectF.bottom + mThumbMargin.bottom);
