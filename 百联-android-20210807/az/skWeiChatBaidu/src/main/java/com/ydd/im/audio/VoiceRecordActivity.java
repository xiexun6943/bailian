...
public class VoiceRecordActivity extends BaseActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        tv1.setText(InternationalizationHelper.getString("JXAudioRecorder_RecorderTip1"));
        tv2.setText(InternationalizationHelper.getString("JXAudioRecorder_RecorderTip2"));
        tv3.setText(InternationalizationHelper.getString("JXAudioRecorder_RecorderTip3"));
        tv4.setText(InternationalizationHelper.getString("JXAudioRecorder_RecorderTip4"));
        leftTv.setText(InternationalizationHelper.getString("JX_Cencal"));
        startTv.setText(InternationalizationHelper.getString("JX_Recorder"));
        rightTv.setText(InternationalizationHelper.getString("JX_Upload"));
    ...
    private void showPager() {
        switch (status) {
            ...
            case RECORD: // 正在录制
            {
                ...
                leftTv.setVisibility(View.GONE);
                rightTv.setVisibility(View.GONE);
                //                startTv.setText("点击暂停");
                //                rightTv.setText("试听");
                startTv.setText(InternationalizationHelper.getString("JXAudioRecorder_PauseRecorder"));
                rightTv.setText(InternationalizationHelper.getString("AUDITION"));
            ...
            case PAUSE:// 暂停录制
            {
                ...
                //                startTv.setText("继续录制");
                startTv.setText(InternationalizationHelper.getString("JXAudioRecorder_ContinueRecorder"));
                linTv.setVisibility(View.GONE);
                timeTv.setVisibility(View.VISIBLE);
            ...
            case PREVIEW: // 试听
            {
                ...
                //                rightTv.setText("上传");
                //                startTv.setText("停止");
                rightTv.setText(InternationalizationHelper.getString("UPLOAD"));
                startTv.setText(InternationalizationHelper.getString("STOP_IT"));
                linTv.setVisibility(View.GONE);
                timeTv.setVisibility(View.VISIBLE);
                backIv.setVisibility(View.GONE);
                titleTv.setVisibility(View.GONE);
            ...
            public void onClick(View v) {
                ...
                } else if (status == PREVIEW) // 试听状态就直接播放音频
                {
                    if (voicePlayStatus == STOP) {
                        ...
                        //                        startTv.setText("播放");
                        startTv.setText(InternationalizationHelper.getString("PLAY"));
                        startIv.setImageResource(R.mipmap.tounded1_normal);
                    }
                }
            }
