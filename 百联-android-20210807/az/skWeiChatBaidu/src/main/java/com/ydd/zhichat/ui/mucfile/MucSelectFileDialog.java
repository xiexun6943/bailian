...
import static com.ydd.zhichat.R.id.tv_group;
...
public class MucSelectFileDialog extends Dialog {
    ...
    private void initView() {
        ...
        mTitle.setText(InternationalizationHelper.getString("JXMyFileVC_SelFile"));
        ...
        mBtn.setText(InternationalizationHelper.getString("JX_Confirm") + "(0)");
        mTextView.setText(InternationalizationHelper.getString("SELECTED") + " 0B");

        //        mTabLayout.addTab(mTabLayout.newTab().setText("影音"));
        //        mTabLayout.addTab(mTabLayout.newTab().setText("图片"), true);
        ...
        mTabLayout.addTab(mTabLayout.newTab().setText(InternationalizationHelper.getString("VIDEO")));
        mTabLayout.addTab(mTabLayout.newTab().setText(InternationalizationHelper.getString("JX_Image")));
        mTabLayout.addTab(mTabLayout.newTab().setText(InternationalizationHelper.getString("FILE")));
        mTabLayout.addTab(mTabLayout.newTab().setText(InternationalizationHelper.getString("APPLICATION")));
        mTabLayout.addTab(mTabLayout.newTab().setText(InternationalizationHelper.getString("OTHER")));
        // 按顺序排列，和tab顺序一致，
    ...
    private void changeDataSource(Map<String, ArrayList> data) {
        ...
        // 还是空数据就弹Toast,
        if (cuttDatas.size() == 0) {
            Toast.makeText(mContext, InternationalizationHelper.getString("JX_NoData"), Toast.LENGTH_SHORT).show();
        }
    }
            ...
            if (f != null) {
                ...
                holder.linearLayout.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        ...
                        mBtn.setText(InternationalizationHelper.getString("JX_Upload") + "(" + opt.size() + ")");
                        mTextView.setText(InternationalizationHelper.getString("SELECTED") + XfileUtils.fromatSize(cuttSize));
