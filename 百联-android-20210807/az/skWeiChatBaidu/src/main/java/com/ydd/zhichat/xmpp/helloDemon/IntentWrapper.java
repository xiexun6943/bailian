...
public class IntentWrapper {
    ...
    public static List<IntentWrapper> whiteListMatters(final Activity a, String reason) {
               ...
               /*case DOZE:
                    if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.N) {
                        ...
                        new AlertDialog.Builder(a)
                                .setCancelable(true)
                                .setIsTitle("需要忽略 " + getApplicationName() + " 的电池优化")
                ...
                case HUAWEI:
                    new AlertDialog.Builder(a)
                            .setCancelable(true)
                            // .setIsTitle("需要允许 " + getApplicationName() + " 自动启动")
                ...
                case XIAOMI_GOD:
                    new AlertDialog.Builder(a)
                            .setCancelable(true)
                            // .setIsTitle("需要关闭 " + getApplicationName() + " 的神隐模式")
                ...
                case MEIZU:
                    new AlertDialog.Builder(a)
                            .setCancelable(true)
                            // .setIsTitle("需要允许视酷IM保持后台运行")
                            // .setTitle("需要允许IM保持后台运行")
                ...
                case GIONEE:
                    new AlertDialog.Builder(a)
                            .setCancelable(true)
                            // .setIsTitle(getApplicationName() + " 需要加入应用自启和绿色后台白名单")
        ...
        if (showed.size() == 0) {// 说明没有可执行的intent 通知到设置界面
            MyApplication.getContext().sendBroadcast(new Intent(com.ydd.zhichat.broadcast.OtherBroadcast.NO_EXECUTABLE_INTENT));
        }
        return showed;
    }
